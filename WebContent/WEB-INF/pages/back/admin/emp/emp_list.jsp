		...
		<div class="content-wrapper text-left">
			<div class="panel panel-success">
				...
				<div class="panel-body">
					<div>
						<jsp:include
							page="/WEB-INF/pages/plugins/split_plugin_search_bar.jsp" />
					</div>
							...
							<c:forEach items="${allEmps}" var="emp">
								<tr>
									<td class="text-center"><input type="checkbox"
										id="eid-${emp.eid}" value="${emp.eid}"></td>
									<td class="text-center"><img
										src="upload/member/${emp.photo}" style="width: 20px;" /></td>
									<td class="text-center">${emp.eid}</td>
									<td class="text-center"><span id="eid-${emp.eid}"
										style="cursor: pointer;">${emp.ename}</span></td>
									...
									<shiro:hasPermission name="emp:edit">
										<td class="text-center"><c:if
												...
												<a type="button" class="btn btn-warning btn-xs"
													href="<%=EMP_EDIT_URL%>?eid=${emp.eid}"> <span
					...
					<div id="splitBarDiv" style="float: right">
						<jsp:include
							page="/WEB-INF/pages/plugins/split_plugin_page_bar.jsp" />
					</div>
				</div>
